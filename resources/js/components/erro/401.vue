<template>
    <div>
        <nav v-if="!isAuth()" class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div id="notfound">
            <div class="notfound">
                ...
                <h2>Oops! You can not access this page.</h2>
                <p>I'm sorry but you're not allowed to access this page talk to the admin or try again later.</p>
                <router-link to="/" tag="a" class="navbar-brand">Back to homepage</router-link>
            </div>
        </div>
    </div>
</template>
